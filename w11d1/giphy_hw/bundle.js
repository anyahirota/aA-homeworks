...
var RECEIVE_SEARCH_GIPHYS = 'RECIEVE_SEARCH_GIPHYS';
...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, giphys.map(function (giphy) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index_item__WEBPACK_IMPORTED_MODULE_1__["default"], {
      giphy: giphy
    }));
  })));
};
...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault(); // let searchTerm = this.state.searchTerm.split(' ').join('+');
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=VCAOdu9G36cGTybpvL8vPlxQx0OwHJqt&limit=2"),
    method: "GET"
  });
};
